...
/** Zero-pressure reference mode — search or tap around the map, see a name and continent. No
 * quiz, no scoring, just a place to look something up or poke around before quizzing yourself
 * for real. */
